    ...
    <div class="card">
        <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">
                <iconify-icon icon="mdi:controller-classic" class="icon-title"></iconify-icon> Tournament Games
            </h5>
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.tournament.game.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
