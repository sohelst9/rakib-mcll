    ...
    <div class="card">
        <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">
                <iconify-icon icon="mdi:gamepad" class="icon-title"></iconify-icon> Battle Games
            </h5>
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.battle.game.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <!-- Game Name Input Section -->
                        <div class="mb-3 row">
                            <label for="name" class="form-label col-sm-3">
                                <iconify-icon icon="mdi:gamepad" class="icon-form"></iconify-icon> Game Name
                            </label>
                            <div class="col-sm-9">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <div class="mt-2" id="imagePreview">
                                    <img id="preview" src="#" alt="Thumbnail Preview" style="max-width: 200px;">
                                </div>
                                @error('thumbnail')
                                    <p class="mt-2 text-danger">{{ $message }}</p>
                                @enderror
