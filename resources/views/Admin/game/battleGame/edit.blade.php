    ...
    <div class="card">
        <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">
                <iconify-icon icon="mdi:gamepad" class="icon-title"></iconify-icon> Battle Game Edit
            </h5>
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.battle.game.update', $game->slug) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
